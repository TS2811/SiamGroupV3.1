        ...
        <Box>
            ...
            <Paper sx={{ p: 2.5, mb: 3, borderRadius: 3 }} elevation={0}>
                <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', alignItems: 'center' }}>
                    ...
                    <TextField size="small" label="เดือนที่ประเมิน" type="month" slotProps={{ inputLabel: { shrink: true } }}
            ...
            {/* Evaluation Dialog */}
            <Dialog open={evalDialog} onClose={() => setEvalDialog(false)} maxWidth="sm" fullWidth slotProps={{ paper: { sx: { borderRadius: 3 } } }}>
