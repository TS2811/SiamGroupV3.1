...
import {
    ...
    DialogContent, DialogActions, Grid, MenuItem, InputAdornment,
            ...
            <Dialog open={dialogOpen && !viewMode} onClose={() => setDialogOpen(false)} maxWidth="md" fullWidth
                ...
                <DialogContent dividers>
                    <Grid container spacing={2} sx={{ mt: 0.5 }}>
                        ...
                        {!editMode && (
                            <>
                                <Grid item xs={12}><Typography variant="subtitle2" fontWeight={700} color="primary">ข้อมูลระบบ</Typography><Divider /></Grid>
                                <Grid item xs={6}><TextField fullWidth size="small" label="Username *" value={form.username || ''} onChange={e => setForm(f => ({ ...f, username: e.target.value }))} /></Grid>
                                <Grid item xs={6}><TextField fullWidth size="small" label="รหัสผ่าน" type="password" value={form.password || ''} onChange={e => setForm(f => ({ ...f, password: e.target.value }))} /></Grid>
                            </>
                        )}
                        {/* Personal */}
                        <Grid item xs={12}><Typography variant="subtitle2" fontWeight={700} color="primary">ข้อมูลส่วนตัว</Typography><Divider /></Grid>
                        <Grid item xs={6}><TextField fullWidth size="small" label="ชื่อ (TH) *" value={form.first_name_th || ''} onChange={e => setForm(f => ({ ...f, first_name_th: e.target.value }))} /></Grid>
                        <Grid item xs={6}><TextField fullWidth size="small" label="นามสกุล (TH) *" value={form.last_name_th || ''} onChange={e => setForm(f => ({ ...f, last_name_th: e.target.value }))} /></Grid>
                        <Grid item xs={6}><TextField fullWidth size="small" label="ชื่อ (EN)" value={form.first_name_en || ''} onChange={e => setForm(f => ({ ...f, first_name_en: e.target.value }))} /></Grid>
                        <Grid item xs={6}><TextField fullWidth size="small" label="นามสกุล (EN)" value={form.last_name_en || ''} onChange={e => setForm(f => ({ ...f, last_name_en: e.target.value }))} /></Grid>
                        <Grid item xs={4}><TextField fullWidth size="small" label="ชื่อเล่น" value={form.nickname || ''} onChange={e => setForm(f => ({ ...f, nickname: e.target.value }))} /></Grid>
                        <Grid item xs={4}><TextField fullWidth size="small" label="เบอร์โทร" value={form.phone || ''} onChange={e => setForm(f => ({ ...f, phone: e.target.value }))} /></Grid>
                        <Grid item xs={4}><TextField fullWidth size="small" label="Email" value={form.email || ''} onChange={e => setForm(f => ({ ...f, email: e.target.value }))} /></Grid>
                        {/* Employment */}
                        <Grid item xs={12}><Typography variant="subtitle2" fontWeight={700} color="primary">ข้อมูลการจ้างงาน</Typography><Divider /></Grid>
                        <Grid item xs={4}><TextField fullWidth size="small" label="รหัสพนักงาน *" value={form.employee_code || ''} onChange={e => setForm(f => ({ ...f, employee_code: e.target.value }))} /></Grid>
                        <Grid item xs={4}>
                        ...
                        <Grid item xs={4}><TextField fullWidth size="small" label="วันเริ่มงาน *" type="date" InputLabelProps={{ shrink: true }} value={form.start_date || ''} onChange={e => setForm(f => ({ ...f, start_date: e.target.value }))} /></Grid>
                        <Grid item xs={4}>
                            <FormControl fullWidth size="small">
                                <InputLabel>สถานะ</InputLabel>
                        ...
                        <Grid item xs={4}><TextField fullWidth size="small" label="เงินเดือนฐาน" type="number" value={form.base_salary || ''} onChange={e => setForm(f => ({ ...f, base_salary: e.target.value }))} /></Grid>
                    </Grid>
                </DialogContent>
