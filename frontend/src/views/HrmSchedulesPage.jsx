...
export default function HrmSchedulesPage() {
    ...
    return (
        <Box>
            ...
            <Dialog open={shiftDialog} onClose={() => setShiftDialog(false)} maxWidth="sm" fullWidth PaperProps={{ sx: { borderRadius: 3 } }}>
                ...
                <DialogContent dividers>
                    <Grid container spacing={2} sx={{ mt: 0.5 }}>
                        ...
                        <Grid item xs={4}><TextField fullWidth size="small" label="รหัสกะ *" value={shiftForm.code || ''} onChange={e => setShiftForm(f => ({ ...f, code: e.target.value }))} /></Grid>
                        <Grid item xs={8}><TextField fullWidth size="small" label="ชื่อกะ (TH) *" value={shiftForm.name_th || ''} onChange={e => setShiftForm(f => ({ ...f, name_th: e.target.value }))} /></Grid>
                        <Grid item xs={6}><TextField fullWidth size="small" label="เวลาเข้า *" type="time" InputLabelProps={{ shrink: true }} value={shiftForm.start_time || ''} onChange={e => setShiftForm(f => ({ ...f, start_time: e.target.value }))} /></Grid>
                        <Grid item xs={6}><TextField fullWidth size="small" label="เวลาออก *" type="time" InputLabelProps={{ shrink: true }} value={shiftForm.end_time || ''} onChange={e => setShiftForm(f => ({ ...f, end_time: e.target.value }))} /></Grid>
                        <Grid item xs={4}><TextField fullWidth size="small" label="พักเที่ยง (นาที)" type="number" value={shiftForm.break_minutes ?? ''} onChange={e => setShiftForm(f => ({ ...f, break_minutes: e.target.value }))} /></Grid>
                        <Grid item xs={4}><TextField fullWidth size="small" label="ชม.ทำงาน" type="number" value={shiftForm.work_hours ?? ''} onChange={e => setShiftForm(f => ({ ...f, work_hours: e.target.value }))} /></Grid>
                        <Grid item xs={4}><TextField fullWidth size="small" label="ผ่อนผันสาย (นาที)" type="number" value={shiftForm.late_grace_minutes ?? ''} onChange={e => setShiftForm(f => ({ ...f, late_grace_minutes: e.target.value }))} /></Grid>
                        <Grid item xs={12}>
            ...
            <Dialog open={assignDialog} onClose={() => setAssignDialog(false)} maxWidth="sm" fullWidth PaperProps={{ sx: { borderRadius: 3 } }}>
                ...
                <DialogContent dividers>
                    <Grid container spacing={2} sx={{ mt: 0.5 }}>
                        ...
                        <Grid item xs={6}><TextField fullWidth size="small" label="วันเริ่มต้น *" type="date" InputLabelProps={{ shrink: true }} value={assignForm.effective_date} onChange={e => setAssignForm(f => ({ ...f, effective_date: e.target.value }))} /></Grid>
                        <Grid item xs={6}><TextField fullWidth size="small" label="วันสิ้นสุด" type="date" InputLabelProps={{ shrink: true }} value={assignForm.end_date} onChange={e => setAssignForm(f => ({ ...f, end_date: e.target.value }))} /></Grid>
                    </Grid>
                </DialogContent>
                <DialogActions sx={{ p: 2 }}>
            ...
            {/* Bulk Assign Dialog */}
            <Dialog open={bulkDialog} onClose={() => setBulkDialog(false)} maxWidth="sm" fullWidth PaperProps={{ sx: { borderRadius: 3 } }}>
                ...
                <DialogContent dividers>
                    <Grid container spacing={2} sx={{ mt: 0.5 }}>
                        ...
                        <Grid item xs={12}><TextField fullWidth size="small" label="วันเริ่มต้น *" type="date" InputLabelProps={{ shrink: true }} value={bulkForm.effective_date} onChange={e => setBulkForm(f => ({ ...f, effective_date: e.target.value }))} /></Grid>
                        <Grid item xs={12}>
                            <FormControl fullWidth size="small">
